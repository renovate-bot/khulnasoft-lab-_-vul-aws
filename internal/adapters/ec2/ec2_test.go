...
func bootstrapEC2Instance(t *testing.T, ra *adapters.RootAdapter, spec instanceDetails) *string {
...
func removeInstance(t *testing.T, ra *adapters.RootAdapter, instanceID *string) {
