...
import (
	...
	"github.com/khulnasoft-lab/vul-aws/internal/adapters/test"
)
...
func destroyVPC(t *testing.T, ra *adapters.RootAdapter, id *string) {
...
func bootstrapVPC(t *testing.T, ra *adapters.RootAdapter, spec vpcDetails) *string {
...
func addFlowLogs(t *testing.T, ra *adapters.RootAdapter, api *vpcApi.Client, vpc *vpcApi.CreateVpcOutput) {
...
func addNacl(t *testing.T, ra *adapters.RootAdapter, spec vpcDetails, api *vpcApi.Client, vpc *vpcApi.CreateVpcOutput) {
...
func addSecurityGroup(t *testing.T, ra *adapters.RootAdapter, spec vpcDetails, api *vpcApi.Client, vpc *vpcApi.CreateVpcOutput) {
