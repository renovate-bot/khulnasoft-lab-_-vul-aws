...
func bootstrapFunction(t *testing.T, ra *adapters.RootAdapter, spec functionDetails) string {
...
func removeFunction(t *testing.T, ra *adapters.RootAdapter, arn string) {
	api := lambdaapi.NewFromConfig(ra.SessionConfig())
